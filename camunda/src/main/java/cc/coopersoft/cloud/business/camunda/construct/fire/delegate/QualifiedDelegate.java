...
@Component
public class QualifiedDelegate extends MessageNotifyDelegate {


    public QualifiedDelegate(FireBusinessService fireBusinessService) {
        super(fireBusinessService);
    }

    @Override
    protected Messages.Type getType() {
        return Messages.Type.Qualified;
    }
