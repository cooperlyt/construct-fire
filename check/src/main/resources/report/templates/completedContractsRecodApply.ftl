...
<div class="page" >
    ...
    <div class="hTitle"><p><strong>建设工程竣工验收消防备案申报表</strong></p></div>
    <div class="right"><p>文号：${fireCheck.id?string["0"]}</p></div>

    <div style="text-align:center;clear: both" >
        <table table style="margin:auto; width:100%;font-size: 90%" border="0" cellspacing="0">
            <tr align="center" valign="middle">
                <td width="50%">建设单位（印章）：</td>
                <td width="50%">填表日期&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;年&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;月&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;日</td>
            </tr>
        </table>
        <table style="margin:auto; width:100%;font-size: 90%" border="1" cellspacing="0">
            <tr align="center" valign="middle">
            ...
            <tr align="center" valign="middle">
                ...
                <td width="12%" colspan="2">竣工验收完成日期</td>
            ...
            <tr align="center" valign="middle">
                ...
                <td width="15%" colspan="1">${pType!}</td>
            </tr>
            <tr align="center" valign="middle">
                <td width="20%" height="40px" colspan="3">
                    <table table style="margin:auto; width:100%;font-size: 100%;padding: 0;" border="0" cellspacing="0" >
                        <tr>
                            <td width="50%" height="40px" style="border-right:2px">消防设计备案凭证文号</td>
                            <td width="40%">${fireCheck.info.fireFile!}</td>
                        </tr>
                    </table>
                </td>
                <td width="20%" colspan="2">受理类别</td>
            ...
            <tr align="center" valign="middle">
                <td width="20%" height="40px" colspan="3">
                    <table table style="margin:auto; width:100%;font-size: 100%;padding: 0;" border="0" cellspacing="0" >
                        <tr>
                            <td width="50%" height="40px" style="border-right:2px">建筑工程施工许可证明文件编号</td>
                            <td width="40%">${fireCheck.info.constructFile!}</td>
                        </tr>
                    </table>
                </td>
                <td width="20%" colspan="2">审核日期</td>
            ...
            <tr align="center" valign="middle">
                <td width="100%" height="40px" colspan="7">
                    <table table style="margin:auto; width:100%;font-size: 90%;padding: 0;" border="0" cellspacing="0" >
                        ...
                        <tr align="center" valign="middle">
                            <td width="3%" style="border-right:2px;border-top: 2px;border-bottom: 0px">堆场</td>
                            <td style="border-right:2px;border-top: 2px;border-bottom: 2px" height="40px" colspan="1">储  量</td>
                            <td style="border-right:2px;border-top: 2px;border-bottom: 2px" colspan="3">${fireCheck.square.area!?string('#.000')}</td>
                            <td style="border-right:2px;border-top: 2px;border-bottom: 2px" colspan="2">储存物质名称</td>
                            <td style="border-top: 2px;border-bottom: 2px" colspan="3">${fireCheck.square.name!}</td>
                        </tr>
                        <#else>
                            <tr align="center" valign="middle">
                                <td width="3%" style="border-right:2px;border-top: 2px;border-bottom: 2px">堆场</td>
                                <td style="border-right:2px;border-top: 2px;border-bottom: 2px" height="40px" colspan="1">储  量</td>
                                <td style="border-right:2px;border-top: 2px;border-bottom: 2px" colspan="3"></td>
                                <td style="border-right:2px;border-top: 2px;border-bottom: 2px" colspan="2">储存物质名称</td>
                                <td style="border-top: 2px;border-bottom: 2px" colspan="3"></td>
                            </tr>
                        </#if>
                        ...
                        <#if fireCheck.warm?exists>
                            <tr align="center" valign="middle">
                                <td width="20%" colspan="2" rowspan="2" style="border-right:2px;border-bottom: 0px" >□建筑保温</td>
                                <td width="20%" colspan="2" style="border-right:2px;border-bottom: 2px" height="40px">材料类别</td>
                                <#if (enumData)?exists>
                                    <#list enumData as enumItem>
                                ...
                                <td width="20%" colspan="2"style="border-right:2px;border-bottom: 2px" >${PWarmType}</td>
                                <td width="20%" colspan="2"style="border-right:2px;border-bottom: 2px" height="40px" >保温层数</td>
                                <td width="20%" colspan="2" style="border-bottom: 0px;border-bottom: 2px">${fireCheck.warm.layers!}</td>

                            </tr>
                            <tr>
                                <td width="20%" colspan="2" style="border-right:2px" height="40px">使用性质</td>
...
<#--                                        </#if>-->
<#--                                    </#list>-->
<#--                                    <td width="20%" colspan="2" style="border-right:2px" >${PUseProperty!}</td>-->
<#--                                 <#else>-->
<#--                                    <td width="20%" colspan="2" style="border-right:2px" ></td>-->
<#--                                </#if>-->
                                <td width="20%" colspan="2" style="border-right:2px" ></td>

                                <td width="20%" colspan="2" style="border-right:2px" height="40px">原有用途</td>
                                <td width="20%" colspan="2">${fireCheck.oldUse!}</td>
                            </tr>
                        <#else>
                            <tr align="center" valign="middle">
                                <td width="20%" colspan="2" rowspan="2" style="border-right:2px;border-bottom: 0px" >□建筑保温</td>
                                <td width="20%" colspan="2" style="border-right:2px;border-bottom: 2px" height="40px">材料类别</td>
                                <td width="20%" colspan="2"style="border-right:2px;border-bottom: 2px" >□A    □B1     □B2</td>
                                <td width="20%" colspan="2"style="border-right:2px;border-bottom: 2px" height="40px" >保温层数</td>
                                <td width="20%" colspan="2" style="border-bottom: 0px;border-bottom: 2px"></td>
                        ...
                        <#if fireCheck.fit?exists>
                            <tr>
                                <td rowspan="3" colspan="2" style="border-right:2px;border-top: 2px">□装修工程</td>
                            ...
                            <tr>
                                <td colspan="2" width="20%" style="border-right:2px;border-bottom: 2px" height="40px">装修面积（m2）</td>
                                <td colspan="2" width="30%" style="border-right:2px;border-bottom: 2px" >${(fireCheck.fit.area?string('#.000'))!}</td>
                                <td colspan="2" width="20%" style="border-right:2px;border-bottom: 2px" height="40px">装修层数</td>
                                <td colspan="2" width="30%" width="20%" style="border-bottom: 2px">${fireCheck.fit.layers!}</td>
                            </tr>
                            <tr>
                                <td colspan="2" width="20%" style="border-right:2px;" height="40px">使用性质</td>
                                <td colspan="2" width="30%" style="border-right:2px;" ></td>
                                <td colspan="2" width="20%" style="border-right:2px;" height="40px">原有用途</td>
                                <td colspan="2" width="30%" width="20%"></td>
                            </tr>
                        <#else>
                            <tr>
                                <td rowspan="3" colspan="2" style="border-right:2px;border-top: 2px">□装修工程</td>
                            ...
                            <tr>
                                <td colspan="2" width="20%" style="border-right:2px;border-bottom: 2px" height="40px">装修面积（m2）</td>
                                <td colspan="2" width="30%" style="border-right:2px;border-bottom: 2px" ></td>
                                <td colspan="2" width="20%" style="border-right:2px;border-bottom: 2px" height="40px">装修层数</td>
                                <td colspan="2" width="30%" width="20%" style="border-bottom: 2px"></td>
                            </tr>
                            <tr>
                                <td colspan="2" width="20%" style="border-right:2px;" height="40px">使用性质</td>
                                <td colspan="2" width="30%" style="border-right:2px;" ></td>
            ...
            <tr align="center" valign="middle">
                <td colspan="7" with="100%" >
                    <table table style="margin:auto; width:100%;font-size: 100%;padding: 0;" border="0" cellspacing="0" >
                        <tr>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">验收内容</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" >验收情况</td>
                            <td width="24%" style="border-right:2px;border-bottom: 2px" height="40px">验收内容</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" >验收情况</td>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">验收内容</td>
                            <td width="10%" style="border-right:0px;border-bottom: 2px" >验收情况</td>
                        </tr>
                        <tr>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">□建筑类别</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="24%" style="border-right:2px;border-bottom: 2px" height="40px">□防火分区</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">□安全疏散</td>
                            <td width="10%" style="border-right:0px;border-bottom: 2px" ></td>
                        </tr>
                        <tr>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">□总平面布局</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="24%" style="border-right:2px;border-bottom: 2px" height="40px">□室外消火栓系统</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">□防烟分区</td>
                            <td width="10%" style="border-right:0px;border-bottom: 2px" ></td>
                        </tr>
                        <tr>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">□平面布置</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="24%" style="border-right:2px;border-bottom: 2px" height="40px">□火灾自动报警系统</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">□消防电梯</td>
                            <td width="10%" style="border-right:0px;border-bottom: 2px" ></td>
                        </tr>
                        <tr>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">□消防水源</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="24%" style="border-right:2px;border-bottom: 2px" height="40px">□室内消火栓系统</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">□防爆</td>
                            <td width="10%" style="border-right:0px;border-bottom: 2px" ></td>
                        </tr>
                        <tr>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">□消防电源</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="24%" style="border-right:2px;border-bottom: 2px" height="40px">□自动喷水灭火系统</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">□灭火器</td>
                            <td width="10%" style="border-right:0px;border-bottom: 2px" ></td>
                        </tr>
                        <tr>
                            <td width="23%" style="border-right:2px;border-bottom: 2px" height="40px">□装修防火</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="24%" style="border-right:2px;border-bottom: 2px" height="40px">□其他灭火设施</td>
                            <td width="10%" style="border-right:2px;border-bottom: 2px" ></td>
                            <td width="23%" style="border-right:2px;border-bottom: 0px" rowspan="2">□其它</td>
                            <td width="23%" style="border-right:0px;border-bottom: 0px" rowspan="2"></td>
                        </tr>

                        <tr>
                            <td width="23%" style="border-right:2px;border-bottom: 0px" height="40px">□建筑保温</td>
                            <td width="10%" style="border-right:2px;border-bottom: 0px" ></td>
                            <td width="24%" style="border-right:2px;border-bottom: 0px" height="40px">□防烟排烟系统</td>
                            <td width="10%" style="border-right:2px;border-bottom: 0px" ></td>
