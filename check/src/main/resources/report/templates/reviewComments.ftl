...
<div class="page" >
    ...
    <div class="hTitle"><p><strong>建设工程竣工验收消防备案复查意见书</strong></p></div>
    <div class="right"><p>东住建消竣复字(${word})第${fireCheck.id?string["0"]}号</p></div>
    <div><p><strong class="underline">${joinCorp.name!}</strong>：</p></div>


    <div class="text"><p>我部门对你单位申报的<strong class="underline">${fireCheck.info.project.name!}</strong>（备案文号及工程信息）进行了竣工验收消防备案复查，认为东住建消竣查字〔   〕第    号《建设工程竣工验收消防备案检查不合格通知书》所提问题已经整改，意见如下：</p></div>
    ...
    <p class="text" >该工程复查结论为合格，可以投入使用。此结论仅对当日验收所涉及的系统及设施情况负责。</p>
    <p class="text" >该工程如需扩建、改建(含室内外装修、建筑保温、用途变更)的，应当依法向建设工程消防设计审查机构申请施工图设计文件审查或备案；属于公众聚集场所的，投入使用、营业前应向消防部门作出符合消防安全标准的承诺。</p>
